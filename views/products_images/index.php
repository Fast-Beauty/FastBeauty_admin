<div class="pcoded-content">
    ...
    <div class="page-header card my-0">
        <div class="d-flex justify-content-between align-items-center pt-3">
            <h3 class="font-weight-bolder">Imagenes de productos</h3>
            <div class="page-header-breadcrumb">
                <ul class=" breadcrumb breadcrumb-title">
                    <li class="breadcrumb-item">
                        <a href="?c=Dashboard&m=dashboard"><i class="feather icon-home"></i></a>
                    </li>
                    <li class="breadcrumb-item"><a href="#!">Imagenes de productos</a> </li>
                </ul>
            </div>
        </div>
        <div class="d-flex justify-content-end align-items-center border-bottom pb-3">
            <a href="?c=ProductsImages&m=create" class="py-3 px-5 rounded text-white add">Nuevo</a> 
        </div>
                            ...
                            <tbody>
                                <?php foreach($this->modelosvc->listar() as $datos): ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?=$this->modelosvc->obtenerProducto($datos['id'])?></td>
                                        <td>
