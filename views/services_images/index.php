<div class="pcoded-content">
    ...
    <div class="page-header card my-0">
        <div class="d-flex justify-content-between align-items-center pt-3">
            <h3 class="font-weight-bolder">Imagenes de Servicios</h3>
            <div class="page-header-breadcrumb">
                <ul class=" breadcrumb breadcrumb-title">
                    <li class="breadcrumb-item">
                        <a href="?c=Dashboard&m=dashboard"><i class="feather icon-home"></i></a>
                    </li>
                    <li class="breadcrumb-item"><a href="#!">Imagenes de Servicios</a> </li>
                </ul>
            </div>
        </div>
        <div class="d-flex justify-content-end align-items-center border-bottom pb-3">
            <a href="?c=ServicesImages&m=create" class="py-3 px-5 rounded text-white add">Nuevo</a> 
        </div>
                                ...
                                <?php foreach($this->modelosvc->listar() as $datos): ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="width:150px">
                                            <img src="data:<?= $datos['tipo_imagen']; ?>;base64,<?= base64_encode($datos['imagen']); ?>" alt="Imagen">
                                        </td>
                                        <td class="text-center"><?=$this->modelosvc->obtenerServicio($datos['id'])?></td>
                                        <td>
                                            <div class="d-flex justify-content-around icon-table">
                                                <a href="?c=ServicesImages&m=show&id=<?= $datos['id'] ?>">
                                                    <span class="feather icon-eye">
                                                        <p class="d-inline text-icn">Detalles</p>
                                                    </span>
                                                </a>
                                                <a href="?c=ServicesImages&m=edit&id=<?= $datos['id'] ?>">
                                                    <span class="feather icon-edit-2">
                                                        <p class="d-inline">Editar</p>
                                                    </span>
                                                </a>
                                                <a href="?c=ServicesImages&m=delete&id=<?= $datos['id'] ?>">
