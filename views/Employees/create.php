            ...
            <div class="">
                <div class="page-header-title">
                    <div class="d-inline">
                        ...
                        <form action="?c=Employees&m=createupdate" class="bg-white px-5 py-4 formulario-user" method="post">
                            <h3 class="mb-4 text-center">Nuevo Trabajador</h3>
                            ...
                            <input type="submit" value="Crear Trabajador" class="submit-user w-100 mt-4 py-3 text-white">
                        </form>
                    </div>
                </div>
            </div>
