<div class="pcoded-content">
    ...
    <div class="page-header card my-0">
        <div class="d-flex justify-content-between align-items-center pt-3">
            <h3 class="font-weight-bolder">Citas</h3>
        ...
        <div class="d-flex justify-content-end align-items-center border-bottom pb-3">
            <a href="?c=Appointments&m=create" class="py-3 px-5 rounded text-white add">Nuevo</a> 
        </div>
                            ...
                            <tbody>
                                <?php foreach ($this->modelosvc->listar() as $datos): ?>
                                    <tr class="bg-white">
                                        ...
                                        <td><?= $datos['date'] ?></td>
                                        <td><?= $datos['hora'] ?></td>
                                        <td><?= $datos['nombre_cliente'] . ' ' . $datos['apellido_cliente']?></td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around icon-table">
                                                <a href="?c=Appointments&m=show&id=<?= $datos['id'] ?>">
                                                    <span class="feather icon-eye">
                                                        <p class="d-inline text-icn">Detalles</p>
                                                    </span>
                                                </a>
                                                <a href="?c=Appointments&m=edit&id=<?= $datos['id'] ?>">
                                                    <span class="feather icon-edit-2">
                                                        <p class="d-inline">Editar</p>
                                                    </span>
                                                </a>
                                                <a href="?c=Appointments&m=delete&id=<?= $datos['id'] ?>">
