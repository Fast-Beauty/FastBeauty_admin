                ...
                <div class="page-header-title">
                    <div class="d-inline">
                        ...
                        <div class="d-flex flex-column mt-2 campo">
                            ...
                            <input id="precio" type="text" placeholder="Precio Producto" autocomplete="off" class="input-form-user py-3 px-2">
                        </div>

                        <div class="d-flex flex-column mt-2 campo">
                            <label for="descripcion">Descripción:</label>
                            <input id="descripcion" type="text" placeholder="Descripción" autocomplete="off" class="input-form-user py-3 px-2">
                        </div>
