        ...
        <div class="row justify-content-center">
            <div class="">
                <div class="page-header-title">
                    ...
                    <form action="?c=Users&m=createupdate" id="formularioUsers" class="bg-white px-5 py-4 formulario-user" method="post">
                        ...
                        <?php foreach($this->modelosvc->obtenerId($_GET['id']) as $datos): ?>
                            ...
                            <div class="d-flex flex-column mt-2 campo">
                                ...
                                <input id="status" name="status" type="text" placeholder="Número de documento" value="<?= $datos['status'] ?>"
                                    autocomplete="off" class="input-form-user py-3 px-2">
                            </div>
                            <?php endforeach; ?>
